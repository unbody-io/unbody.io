...
![A regular tech stack for a simple chatbot](./image-01.png "A regular tech stack for a simple chatbot")

_A regular tech stack for a simple chatbot - from _[_@aigeek\_\__](https://x.com/aigeek__/status/1717046220714308026)
...
![Decisions involved in building an LLM app](./image-02.png "Decisions involved in building an LLM app")
...
![Unbody as an invisible AI layer and headless API](./image-03.png "Unbody as an invisible AI layer and headless API")
...
![layer 1: connect your data to unbody](./image-04.gif "layer 1: connect your data to unbody")
...
![Layer 2: compose your favorite AI engines for all data types; text, image, audio and video](./image-05.gif "Layer 2: compose your favorite AI engines for all data types; text, image, audio and video")
...
![Basic content retrieval demo](./image-06.gif "Basic content retrieval demo")

- **Semantic Search**: Dive deep into the meaning behind words and phrases in your data

![Semantic search demo](./image-07.gif "Semantic search demo")

- Generative search

![Generative search demo](./image-08.gif "Generative search demo")
...
Our Image API, powered by Imgix, offers a range of tools for image processing and manipulation, enriching your applications with powerful image handling capabilities. [Explore more about the Image API here](https://www.unbody.io/docs/image-api/overview).

**Video API (Powered by Mux)**

This API, in collaboration with Mux, brings advanced video functionalities to your fingertips. [More details on Video API capabilities here](https://www.unbody.io/docs/video-api).
...
![Unbody AI use cases overview](./image-09.png "Unbody AI use cases overview")
...
![IsiaUrbino platform using Google Drive as CMS via Unbody](./image-10.png "IsiaUrbino platform using Google Drive as CMS via Unbody")

_Unbody enabled IsiaUrbino platform to offer their students to use google drive as their CMS - _[_isiaurbino.net_](https://www.isiaurbino.net/)

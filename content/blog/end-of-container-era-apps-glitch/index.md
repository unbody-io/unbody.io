...
![Server ships Pages but the mind follows Threads, visualizing the disconnect](./image-01.png "Server ships Pages but the mind follows Threads, visualizing the disconnect")

_The server ships Pages (grey boxes), but the mind follows Threads (red arrows). Visualizing the disconnect in Re (2016)._ View full slides on [GitHub](https://github.com/amirhouieh/re-/blob/master/resources/presentation_0.1_2.pdf)

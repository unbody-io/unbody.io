...
![Architecture diagram of the AI meeting assistant workflow](./image-01.png "Architecture diagram of the AI meeting assistant workflow")
...
![Meeting AI Assistant generated report on Appsmith dashboard](./image-02.png "Meeting AI Assistant generated report on Appsmith dashboard")

_Meeting AI Assistant generated report on Appsmith dashboard_

See the following GIF to understand the whole process:

![The process of creating Google Meet AI Assistant app with Unbody](./image-03.gif "The process of creating Google Meet AI Assistant app with Unbody")
...
![Starting a Google Meet recording to generate transcriptions](./image-04.png "Starting a Google Meet recording to generate transcriptions")
...
![Video recording is automatically saved to Google Drive](./image-05.png "Video recording is automatically saved to Google Drive")
...
![Unbody create a new project with data sources](./image-06.png "Unbody create a new project with data sources")
...
![Google Drive and Calendar are chosen data sources for Unbody](./image-07.png "Google Drive and Calendar are chosen data sources for Unbody")
...
![Writing custom queries on Unbody GraphQL playground](./image-08.png "Writing custom queries on Unbody GraphQL playground")
...
![Example of Appsmith canvas to build UI apps](./image-09.png "Example of Appsmith canvas to build UI apps")

_Example of Appsmith canvas to build UI apps_

You can use the drag-and-drop interface to customize the dashboard. Modify or add widgets like tables, text boxes, and buttons as needed. Note that Appsmith doesn't export any secret configuration or header values used for connecting a data source such as Unbody `API_KEY`and `PROJECT_ID`. You need to find your [personal API key](https://www.unbody.io/docs/api/authorization) and project ID generated in the Unbody Dashboard and configure manually in the data source headers similar to this:

![Connect Unbody as a data source to Appsmith](./image-10.png "Connect Unbody as a data source to Appsmith")
...
![Register Unbody GraphQL queries for Appsmith](./image-11.png "Register Unbody GraphQL queries for Appsmith")
...
![Appsmith meeting AI assistant repo UI demo](./image-12.gif "Appsmith meeting AI assistant repo UI demo")
...
This setup guide provides a basic framework, which you can expand and customize according to your specific requirements. In the application, you noticed that there is another non-finished page called **Ask Meeting Notes.** Apply the knowledge you learned in this article and implement a new GraphQL query using the [Generative Q\&A](https://www.unbody.io/docs/api/search/generative-qa) feature, [bringing data](https://www.unbody.io/docs/api/search/generative-qa) to the output text widget. Users can search for specific information from the meetings in the search bar.
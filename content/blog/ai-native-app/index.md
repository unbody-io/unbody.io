...
![Traditional vs AI-native data management for personalization](./image-01.png "Traditional vs AI-native data management for personalization")
...
![Context awareness through semantically connected data sources](./image-02.png "Context awareness through semantically connected data sources")
...
![Shift from information seeking to conversational interaction with software](./image-03.png "Shift from information seeking to conversational interaction with software")
...
![Technical breakdown of AI-native app components](./image-04.png "Technical breakdown of AI-native app components")
...
![Complexity of assembling a full AI-native system from scratch](./image-05.png "Complexity of assembling a full AI-native system from scratch")
...
![How Unbody simplifies AI-native app development](./image-06.png "How Unbody simplifies AI-native app development")
...
[short-js-semantic-search.mp4](https://www.unbody.io/images/blog/ai-native/short-js-semantic-search.mp4)

Just connect your data, select your AI stack, and start building with just one line of code.

## Examples

Here are a few examples open-source AI-native products that we have built using [Unbody.io](https://unbody.io/). Hope this gives you a better idea. We are always open to new ideas in AI-native app production, so in case you’ve got any, please reach out and let's see how we can help.

- [**Nextlog**](https://github.com/unbody-io/Gray): Nextlog is an AI-native, open-source blogging framework built on Unbody.io that makes reading more contextual and dynamic.&#x20;

> [x.com/unbody\_io](https://x.com/unbody_io)

Githubunbody.ioExample boilerplate for Unbody.io's typescript SDK in Next.Js (Page Router)19th, April 2024[Visit source code on GitHub.](https://github.com/unbody-io/example-next.js)

> [x.com/amirhouieh](https://x.com/amirhouieh)
...
![Unbody-powered search plugin for websites and documentation](./image-07.png "Unbody-powered search plugin for websites and documentation")
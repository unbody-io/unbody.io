---
title: Build A.I. apps with your data
---
...
export const PageContent = () => {
    const {sections, features, providers, files} = useSSG();
    return (
        <>
...
<div className={"home-content"}>
  <div className="content-container">
    <NewHero />
        <div className="text-paraghraph_gray text-base text-center h-20 px-4 lg:hidden">
      </div>
    <PageContent />

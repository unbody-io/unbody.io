...
- **`where`**: Apply filters to refine search results. You can learn more about filters [here](Filters%207bbc3adfe896410bb78bb39de041f3fb.md).
...
- **`nearText`:** This argument helps you find objects that are semantically similar to the given text. You can learn more about semantic search [here](Semantic%20Search%2034c48ca0ce92465ea59cc0167483a353.md).

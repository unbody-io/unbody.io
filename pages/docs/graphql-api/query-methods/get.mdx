...
- **`where`**: Apply filters to refine search results. You can learn more about filters [here](/docs/graphql-api/filters).
...
- **`nearText`:** This argument helps you find objects that are semantically similar to the given text. You can learn more about semantic search [here](/docs/graphql-api/search/semantic-search).

---
title: "AI in 2023: The Increasing Gap Between AI as Tech and Its Applications"
authors: [{name: "Amir Houieh", link: "https://www.linkedin.com/in/amirhouieh/", image: "amir.png"}]
audience_group: business professionals
outline: "Exploring the gap between AI's technological advancements and its practical business applications in 2023. From legal to healthcare and publishing sectors, the article delves into the underutilization of AI in business, the complexity barrier, and the need for diverse involvement in AI. Introducing Unbody as a solution to make AI accessible for all."
...
<BlogPostHeader title={"AI in 2023: The Increasing Gap Between AI as Tech and Its Applications"}
                authors={[{name: "Amir Houieh", link: "https://www.linkedin.com/in/amirhouieh/", image: "amir.png"}]}
                date={"2023-12-11"}
                type={"page"}
                subtitle={"Bridging the Technology-Business Divide in AI"}

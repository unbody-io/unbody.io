...
Unbody started with a simple yet powerful vision: to make AI technology accessible for every developer in any field and level. We saw the challenges in integrating AI – the complexity of the technology, the fragmentation of data, and the high barrier to entry for non-experts. Our response? A platform that demystifies AI, making it a tool for innovation, not a hurdle.

## What Unbody Offers
Unbody is an invisible AI layer, a headless API that turns diverse content from any source into actionable knowledge. We provide a straightforward solution for developers at any level to create applications that understand and utilize content effectively, straight out of the box.
...
<div className={"grid"}>
    ...
    <TeamMemberCard name="Hossein Mehrabi"
                    ...
                    links={[
                        ...
                        {name: "LinkedIn", href: "https://www.linkedin.com/in/hossein-m-163095191/"},
                    ]}
    />
</div>

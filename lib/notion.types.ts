import {
    ...
    PartialUserObjectResponse, TextRichTextItemResponse,
    UserObjectResponse
...
export type RollupNumberProperty = {
    type: 'number';
    number: number | null;
    function: RollupFunction;
};

export type RollupDateProperty = {
    type: 'date';
    date: DateResponse | null;
    function: RollupFunction;
};

export type RollupArrayProperty = {
    type: 'array';
    array: Array<{
        type: 'title';
        title: Array<RichTextItemResponse>;
...
export type RollupProperty = {
    type: 'rollup';
    rollup: RollupNumberProperty | RollupDateProperty | RollupArrayProperty;
    id: string;
};

export type NotionDatabaseProp = NumberProperty
    | UrlProperty
    | SelectProperty
    | MultiSelectProperty
    | StatusProperty
    ...
    | PeopleProperty
    | RelationProperty
    | RollupNumberProperty
    | RollupDateProperty
    | RollupArrayProperty
    | RollupProperty;

export type NotionDatabaseProperties = Record<string, NotionDatabaseProp>

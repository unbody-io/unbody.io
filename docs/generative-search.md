...
__path__: >-
  [{"title":"Docs","route":"/docs"},{"title":"Generative
  Search","route":"/docs/generative-search"}]
---
...
-   **Cohere** Cohere’s models excel in producing fluent and grammatically correct responses, and they're continuously updated to ensure current, up-to-date language generation.
...
-   **PaLM** PaLM's models, with their high token limits, are particularly suited for tasks that require processing large amounts of text or generating detailed responses. They provide contextually rich and nuanced answers.

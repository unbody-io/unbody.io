...
### Video and Audio Transcription[](#video-and-audio-transcription)
...
### 1\. Mux Default Transcription[](#1-mux-default-transcription)
...
### 2\. Whisper (OpenAI Model)[](#2-whisper-openai-model)
...
[Summary Generation](/docs/textual-content-augmentation/summary-generation "Summary Generation")[Visual Search](/docs/visual-search "Visual Search")
...
## Combining Parameters for Advanced Transformations[](#combining-parameters-for-advanced-transformations)
...
## Most Common Use Cases[](#most-common-use-cases)

### Building Responsive Images[](#building-responsive-images)
...
### Cropping for Portrait Images[](#cropping-for-portrait-images)
...
### Implementing Lazy Loading with a Blur Effect[](#implementing-lazy-loading-with-a-blur-effect)
...
[API Reference](/docs/image-api/api-reference "API Reference")[Audio API](/docs/audio-api "Audio API")
...
__path__: >-
  ...
  API","route":"/docs/image-api"},{"title":"Overview","route":"/docs/image-api/overview"}]
---
...
[TypeScript Client](/docs/libraries/typescript-client "TypeScript Client")[API Reference](/docs/image-api/api-reference "API Reference")
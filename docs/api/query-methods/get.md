...
title: Get
__path__: >-
  [{"title":"Docs","route":"/docs"},{"title":"API","route":"/docs/api"},{"title":"Query
  Methods","route":"/docs/api/query-methods"},{"title":"Get","route":"/docs/api/query-methods/get"}]
---
...
-   **`distance`:** This property results in distance in vector space for search results. If you do not understand distance, don’t worry you learn more about it [here (opens in a new tab)](https://ocw.mit.edu/ans7870/18/18.013a/textbook/HTML/chapter03/section08.html#:~:text=The%20distance%20between%20two%20vectors,we%20have%20the%20Pythagorean%20theorem.).
...
[QnA](/docs/api/q-n-a "QnA")[Aggregate](/docs/api/query-methods/aggregate "Aggregate")
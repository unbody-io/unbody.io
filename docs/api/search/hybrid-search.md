...
### Example 2 - Discord Messages[](#example-2---discord-messages)
...
### Example 4 - Google Drive / Google Docs with specific fields[](#example-4---google-drive--google-docs-with-specific-fields)
...
## Fusion (Ranking) Method: Fine-Tune Your Results[](#fusion-ranking-method-fine-tune-your-results)
...
## Target Specific Properties: Get Precise[](#target-specific-properties-get-precise)
...
## Boosting Properties: Give Priority Where Needed[](#boosting-properties-give-priority-where-needed)
...
## Bring Your Own Vectors: Customized Semantic Search[](#bring-your-own-vectors-customized-semantic-search)
...
## Add a Conditional Filter: Refine Your Search[](#add-a-conditional-filter-refine-your-search)

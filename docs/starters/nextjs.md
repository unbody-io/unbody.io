---
title: Unbody Next.js Starter - Unbody
---
![Unbody + Nextjs](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnextjs.1da24783.png&w=3840&q=75)
...
## Overview of Unbody's AI Functionalities[](#overview-of-unbodys-ai-functionalities)
...
### Setup Unbody.io[](#setup-unbodyio)

1.  Create an account on [Unbody.io (opens in a new tab)](https://unbody.io)
...
### Client-side Component for Handling User Input[](#client-side-component-for-handling-user-input)
...
### Server-side: Performing Search with Unbody[](#server-side-performing-search-with-unbody)
...
#### Specifics for Each Provider[](#specifics-for-each-provider)
...
### Handling Different Providers[](#handling-different-providers)
...
#### Provider-Specific Content Generation Strategies[](#provider-specific-content-generation-strategies)
...
### Generative Output Formatting[](#generative-output-formatting)
...
[With TextBlocks](/docs/get-started/step-2-building/build-with-textblocks "With TextBlocks")[Integrating with CRA](/docs/starters/cra "Integrating with CRA")
...
__path__: >-
  [{"title":"Docs","route":"/docs"},{"title":"Question
  Answering","route":"/docs/question-answering"}]
---
...
For further details, you can refer to the [Weaviate documentation (opens in a new tab)](https://weaviate.io/developers/weaviate/modules/reader-generator-modules/qna-openai).
...
For a more detailed explanation, you can visit the [Weaviate documentation (opens in a new tab)](https://weaviate.io/developers/weaviate/modules/reader-generator-modules/qna-openai).
...
[Generative Search](/docs/generative-search "Generative Search")[Overview](/docs/textual-content-augmentation/overview "Overview")
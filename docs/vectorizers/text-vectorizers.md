...
### Cohere: text2vec-cohere[](#cohere-text2vec-cohere)
...
### HuggingFace: Text2vec-huggingface[](#huggingface-text2vec-huggingface)
...
### OpenAI: Text2vec-openai[](#openai-text2vec-openai)
...
### Palm: Text2vec-palm[](#palm-text2vec-palm)
...
### Text2vec-contextionary[](#text2vec-contextionary)
...
[Overview](/docs/vectorizers/overview "Overview")[Image Vectorizers](/docs/vectorizers/image-vectorizers "Image Vectorizers")
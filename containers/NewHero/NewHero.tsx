...
import {FrameItem, heroFrames, ProviderItem, providersInDeck} from "../../lib/hero.config";
...
const ProviderDeck = ({activeFrame}: ProviderDeckProps) => {
    ...
    console.log(activeFrame.key, activeFrame.providers.map(p => p.name));
            ...
            <div className={styles.providersDeck}>
                {
                    providersInDeck.map((provider: ProviderItem, index) => (
                        <ProviderIcon
                            ...
                            active={
                                activeFrame.providers
                                    .findIndex((p) => p.name === provider.name) !== -1
                            }

...
const LinkButton = ({children, outlined = false, href}: PropsWithChildren<{href: string; outlined?: boolean}>) => {
    const baseHoverClassNames = "transition-all duration-300 hover:scale-105 hover:shadow-lg";
    ...
    const extraClassNames = outlined ? "text-white-100 border-neutral-500 bg-indigo-10 shadow-lg shadow-indigo-100/10": "bg-white text-gray-800";
    ...
    const arrowExtraClassNames = outlined ? "text-gray-800": "bg-gray-800 text-white-100";

    return (
        <Link href={href}
              className={`${baseClassNames} ${extraClassNames}`}
        >

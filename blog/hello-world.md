...
outline: >-
  In a world where everyone seeks apps with human-like understanding, the
  challenge isn't just in the idea, but in the development. Unbody steps in to
  make AI app creation accessible, even for non-AI developers. Discover how
  Unbody simplifies the complex, welcoming all into the future of AI.
seo_tags: >-
  llm (large language models), rag api, ai for private data, semantic search ai,
  visual search ai, generative search ai, qa bot development, chatbot for
  private data, multimodal ai applications, ai personalization tools, ai data
  integration, ai app development, developer-friendly ai tools, advanced ai
  technologies, unbody ai platform
category:
  - introduction
  - unbody
  - general
subtitle: >-
  An invisible layer, a headless ai api, a seamless modular pipeline from
  private data to frontend
date: '2023-11-28T00:00:00.000Z'
image: /images/blog/hello-world.jpg
__path__: >-
  [{"title":"Blog","route":"/blog"},{"title":"Unbody: all AI buzz in one
  endpoint, one line of code","route":"/blog/hello-world"}]
---
...
_A regular tech stack for a simple chatbot - from [@aigeek\_\_ (opens in a new tab)](https://x.com/aigeek__/status/1717046220714308026)_
...
_The decisions you have to make when it comes to building LLM app - [Jery liu - CEO of LlamaIndex (opens in a new tab)](https://blog.llamaindex.ai/introducing-llama-packs-e14f453b913a)_
...
_4 layers of a seamless modular AI pipeline from private data to frontend_
...
_layer 1: connect your data to unbody_
...
_Layer 2: compose your favorite AI engines for all data types; text, image, audio and video_
...
_Unbody enabled IsiaUrbino platform to offer their students to use google drive as their CMS - [isiaurbino.net (opens in a new tab)](https://www.isiaurbino.net)_

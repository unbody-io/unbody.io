---
title: 'Unbody: all AI buzz in one endpoint, one line of code - Unbody'
---
November 28th, 2023 |

[Amir Houieh](https://www.linkedin.com/in/amirhouieh/)
...
![Unbody: all AI buzz in one endpoint, one line of code](/images/blog/hello-world.jpg)
...
### Big elephant in the room[](#big-elephant-in-the-room)
...
### Challenge 1 - Personalisation[](#challenge-1---personalisation)
...
### Challenge 2 - Your data: where it lives and its many faces[](#challenge-2---your-data-where-it-lives-and-its-many-faces)
...
### Challenge 3 - The developer's tightrope[](#challenge-3---the-developers-tightrope)

![A regular tech stack for a simple chatbot](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fregular-chatbot-techstack.352ec00a.jpeg&w=3840&q=75) _A regular tech stack for a simple chatbot - from [@aigeek\_\_ (opens in a new tab)](https://x.com/aigeek__/status/1717046220714308026)_
...
![The decisions you have to make when it comes to building LLM app - Jery liu (CEO of LlamaIndex)](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fllm-decisions.58d46ca3.png&w=1920&q=75) _The decisions you have to make when it comes to building LLM app - [Jery liu - CEO of LlamaIndex (opens in a new tab)](https://blog.llamaindex.ai/introducing-llama-packs-e14f453b913a)_
...
## Let’s put all fancy words in one box[](#lets-put-all-fancy-words-in-one-box)
...
![unbody seamless ai pipeline - overall concept](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsolution.e66a38b7.png&w=3840&q=75)
...
![unbody seamless AI pipeline - architect](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Funbody-semaless-ai-pipeline-architect.a1119e1e.png&w=3840&q=75) _4 layers of a seamless modular AI pipeline from private data to frontend_

### **Layer 1: Data Aggregation and Integration**[](#layer-1-data-aggregation-and-integration)
...
![Seamless modular pipeline from private data to frontend](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fflow.e0e34e4f.gif&w=1920&q=75) _layer 1: connect your data to unbody_
...
### ****Layer 2: AI data processing and enhancement****[](#layer-2-ai-data-processing-and-enhancement)
...
![Unbody modular LLM and ML architect](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmodular.3f3eec5d.gif&w=1920&q=75) _Layer 2: compose your favorite AI engines for all data types; text, image, audio and video_
...
### Layer 3: Delivery and interaction[](#layer-3-delivery-and-interaction)
...
![Unbody - how to do basic content retrieval](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffilters.feff1e0b.gif&w=1920&q=75)

-   **Semantic Search**: Dive deep into the meaning behind words and phrases in your data

![Unbody - how to do semantic Search](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsemantic-hybrid-search.43ce86c3.gif&w=1920&q=75)

-   Generative search

![Unbody - generative search](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgen.e3f11468.gif&w=1920&q=75)
...
#### Additional APIs for enhanced functionality[](#additional-apis-for-enhanced-functionality)
...
### Layer 4: Application realization & use-cases[](#layer-4-application-realization--use-cases)
...
![Unbody - AI use-cases](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fusecase.9dba21a8.jpg&w=3840&q=75)
...
![Unbody - Content management use-cases](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Funbody-as-cms.a0cd8b1b.jpeg&w=2048&q=75) _Unbody enabled IsiaUrbino platform to offer their students to use google drive as their CMS - [isiaurbino.net (opens in a new tab)](https://www.isiaurbino.net)_
...
## **The ~end~ beginning**[](#the-end-beginning)
...
A huge shout-out to the amazing team at [Weaviate (opens in a new tab)](https://weaviate.io), the powerhouse engine behind Unbody! 💛
...
Last but not least, our freemium plan is available for you to try out Unbody for free. [Sign up here (opens in a new tab)](https://app.unbody.app/) and start building your AI applications today! 🚀

[Bounties: Rethinking the design of blogging for the AI age (#1)](/blog/bounty-blog-template "Bounties: Rethinking the design of blogging for the AI age (#1)")[Navigating AI Trends: Insights from Web Summit 2023 with Unbody](/blog/ai-at-websummit "Navigating AI Trends: Insights from Web Summit 2023 with Unbody")
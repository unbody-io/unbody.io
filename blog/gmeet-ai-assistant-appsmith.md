...
![How to build a Google Meet AI assistant app in 10 minutes with Unbody & AppSmith](/images/blog/gmeet-ai-assistant-appsmith.png)
...
## Introducing the AI-powered meetings assistant app[](#introducing-the-ai-powered-meetings-assistant-app)
...
![AI Powered Team Meetings Summary (3).png](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FAI_Powered_Team_Meetings_Summary_(3).bbf91a31.png&w=3840&q=75)
...
![Meeting AI Assistant generated report on Appsmith dashboard](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled.0b6bdc43.png&w=3840&q=75) _Meeting AI Assistant generated report on Appsmith dashboard_

See the following GIF to understand the whole process:

![The process of creating Google Meet AI Assistant app with Unbody](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FMeeting_Minutes_Report_v5.8a328df9.gif&w=3840&q=75) _The process of creating Google Meet AI Assistant app with Unbody_
...
### Step 1: Activate a video recording in Google Meet[](#step-1-activate-a-video-recording-in-google-meet)

Once you are in the meeting, start a video recording and transcript in your Google Meet session.

![Start the Google Meet recording to generate transcriptions for Unbody](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_1.7e2d5f5f.png&w=3840&q=75)
...
![Video recording is automatically saved to Google Drive](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_2.a0db4dae.png&w=3840&q=75) _Video recording is automatically saved to Google Drive_

### Step 2: Setting up the Unbody project[](#step-2-setting-up-the-unbody-project)
...
![Unbody Features setting](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_3.6a0d33f9.png&w=3840&q=75) _Unbody Features setting_
...
![Unbody create a new project with data sources](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_4.9017454b.png&w=3840&q=75) _Unbody create a new project with data sources_

After you successfully connect to data sources, you should see Google Drive and Google Calendar in the sources list:

![Google Drive and Calendar are chosen data sources for Unbody](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_5.838c2de9.png&w=3840&q=75) _Google Drive and Calendar are chosen data sources for Unbody_

### Step 4: Write GraphQL queries[](#step-4-write-graphql-queries)
...
![Writing custom queries on Unbody GraphQL playground](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_6.857b0ed6.png&w=3840&q=75) _Writing custom queries on Unbody GraphQL playground_

### Step 5: Setting up the frontend with Appsmith[](#step-5-setting-up-the-frontend-with-appsmith)
...
![Example of Appsmith canvas to build UI apps](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_7.54b51969.png&w=3840&q=75) _Example of Appsmith canvas to build UI apps_
...
![Connect Unbody as a data source to Appsmith](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_8.4737ba69.png&w=3840&q=75) _Connect Unbody as a data source to Appsmith_
...
![Register Unbody GraphQL queries for Appsmith](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FUntitled_9.c6075f17.png&w=3840&q=75) _Register Unbody GraphQL queries for Appsmith_
...
![Appsmith meeting AI assistant repo UI demo](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FAI-powered_meetings_assistant_app_UI_demo.2f5eb28d.gif&w=3840&q=75) _Appsmith meeting AI assistant repo UI demo_
